...
public class ParticleBehavior : MonoBehaviour
{
  ...
  void AddElectroStaticForce(GameObject particle)
  {
    if (particle != null)
    {
      ...
      // We normalize the direction vector because we want to use the force magnitude we calculated here to determine the magnitude of the force vector applied:
